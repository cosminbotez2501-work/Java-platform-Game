...
public abstract class Item
{
    ...
    public Rectangle getAbsoluteBounds(Rectangle localBounds)
    {
        return new Rectangle((int)(x + localBounds.x), (int)(y + localBounds.y), localBounds.width, localBounds.height);
    }

    public boolean intersectsAttack(Item other)
    {
        Rectangle thisAttackBounds = getAbsoluteBounds(this.attackBounds);
        Rectangle otherBounds = other.getAbsoluteBounds(other.normalBounds);
        return thisAttackBounds.intersects(otherBounds);
    }
